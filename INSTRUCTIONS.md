...
## STEP PATCH_12J1 - Allow Flow adapter to receive shared browser adapter
...
## STEP PATCH_12J2 - Reuse shared Playwright/CDP objects inside Flow `_page()`
...
## STEP PATCH_12J3 - Pass active ChatGPT browser adapter into Flow adapter factory
...
## STEP J-Validation 2 - Static marker check
...
## STEP J-Validation 3 - Routing/session dry-run
...
## STEP Resume Validation 5 - Step 12 Flow actual generation smoke test
